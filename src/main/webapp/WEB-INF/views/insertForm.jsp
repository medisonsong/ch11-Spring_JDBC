...
<div class="page-main">
	<h2>글쓰기</h2>
	<form:form action="insert.do" modelAttribute="boardVO"> <%-- 속성명을 명시하지 않았기 때문에 boardVO가 됨 --%>
	<ul>
		<li>
			<form:label path="writer">작성자</form:label>
			<form:input path="writer"/>
			<form:errors path="writer" cssClass="error-color"/> <%-- cssClass=커스텀태그가 제공하는 속성임 (이후에 클래스로 변신함) --%>
		</li>
		<li>
